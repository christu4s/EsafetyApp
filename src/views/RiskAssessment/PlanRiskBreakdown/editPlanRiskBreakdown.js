...
export const EditPlanRiskBreakdown = () => {
                            ...
                            <Panel header="Edit" key="1">
                                ...
                                <Row >
                                    <Col span={24} style={{ textAlign: 'right' }}>
                                        <Button type="default" className='ps-btn' style={{ textAlign: 'right', color: "#000" }} block >
                                            Edit
                                        </Button>
                                    </Col>
                                </Row>
                                        ...
                                        >
                                            ...
                                            <Row style={{ paddingTop: 20 }}>
                                                <Col span={12} style={{ paddingTop: 5 }}>
                                                    <p style={{ marginBottom: 15 }}>Toxic 2</p>
                                                </Col>
                                            ...
                                            <Row >
                                                <Col span={12} style={{ paddingTop: 5 }}>
                                                    <p style={{ marginBottom: 0 }}>Toxic 3</p>
                                                </Col>
                                                <Col span={12} style={{ textAlign: 'right' }}>
                                                    <Link href="#" style={{ paddingTop: 3, display: 'inline-block' }}>
                                                        Edit
